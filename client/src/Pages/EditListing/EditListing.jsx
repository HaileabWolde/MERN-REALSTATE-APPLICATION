...
const handleImageSubmit = () => {
  ...
  const handleSubmit = async (e)=>{
    e.preventDefault();
    const lisitingId = params.id
    const endpoint = `https://curious-toad-sweater.cyclic.app/lisiting/editListing/${lisitingId}`
    try{
      setLoading(true)
...
return (
    <div>
        ...
        <h1 className="font-bold text-center my-12 text-4xl">Edit a Lisiting</h1>
        <form className="flex flex-col md:flex-row gap-4" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-4">
              ...
              {formdata.imageurl.length > 0 &&
                ...
                <button className="bg-slate-700 text-white p-3 rounded-lg" type="submit">{loading ? 'Editiing ...' : 'EDIT LISTIING'}</button>
