...
const Home = ()=>{
    ...
    useEffect(() => {
        const fetchOffer = async () => {
            try {
                const res = await fetch('https://curious-toad-sweater.cyclic.app/lisiting/getBySearch?Offer=true&limit=4');
        ...
        const fetchRent = async () => {
            try {
                const res = await fetch('https://curious-toad-sweater.cyclic.app/lisiting/getBySearch?type=Rent&limit=4');
                const data = await res.json();
                setRent(data)
                fetchSell()
            } catch (error) {
        ...
        const fetchSell = async () => {
            try {
                const res = await fetch('https://curious-toad-sweater.cyclic.app/lisiting/getBySearch?type=Sell&limit=4');
                const data = await res.json();
                setSell(data)
            } catch (error) {
                console.log(error);
