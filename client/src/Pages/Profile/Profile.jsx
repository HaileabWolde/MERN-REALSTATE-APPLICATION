...
const Profile = ()=>{
  ...
  const handleSubmit = async (e)=>{
    e.preventDefault()
    let endpoint = `https://curious-toad-sweater.cyclic.app/users/update/${CurrentUser._id}`
    try{
  ...
  const handleDelete = async ()=>{
        ...
        let endpoint = `https://curious-toad-sweater.cyclic.app/users/delete/${CurrentUser._id}`
        try{
...
const handleListing = async ()=> {
  let endpoint = `https://curious-toad-sweater.cyclic.app/lisiting/getListing`
...
const DeleteListing = async(Lisitingid)=>{
  let endpoint = `https://curious-toad-sweater.cyclic.app/lisiting/deleteListing/${Lisitingid}`
  try{
    const res = await fetch(endpoint, {
      method: 'DELETE',
      headers: {
